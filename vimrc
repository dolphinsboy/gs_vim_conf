...
let g:persistentBehaviour=0          "exit when it is the last win 
nmap <silent> <leader>wm :WMToggle<cr>

"cscope
if has("cscope")
    set cscopetag   " suport Ctrl+]  and  Ctrl+t 
...
"set statusline=\ %{HasPaste()}%F%m%r%h%w\ %w\ \CWD:\ %r%{getcwd()}%h\ [POS=%04l,%04v][%p%%]\ Line:\ %l Col:\ %v
set statusline=\ %{HasPaste()}%F%m%r%h%w\ %w\ [Line=%04l,Col=%04v]
